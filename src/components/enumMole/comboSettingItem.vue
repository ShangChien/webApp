      ...
      >
        ...
        <div class="flex-auto gridView place-items-center min-w-400px rd-1.5 bg-white m-1 mt-0">
          ...
          <div class="b-(2 rd-2 solid indigo-50) bg-slate-50 flex flex-nowrap mr-2">
            ...
            >
              <div v-if="v.connect2index.includes(option.value)" class="i-carbon-circle-filled text-3xl m-0.2" />
              <div
                v-else class="i-ic-sharp-circle text-3xl opacity-20 m-0.2 hover:(i-carbon-circle-filled duration-210 opacity-70 ease-in-out)"
              />
            </div>
          </div>
          ...
          <div class="b-(2 rd-2 solid indigo-50) bg-slate-50 flex flex-nowrap">
            ...
            >
              <div v-if="v.keepSame2Index.includes(+option)" class="i-carbon-circle-filled text-3xl m-0.2" />
              <div
                v-else class="i-ic-sharp-circle text-3xl opacity-20 m-0.2 hover:(i-carbon-circle-filled duration-210 opacity-70 ease-in-out)"
              />
            </div>
