...
<div>
  <n-space vertical>
    <n-input-group class="inputG" >
      ...
      <n-button type="info" strong secondary round size="large" style="font-size:20px"
          @click="showketcher=!showketcher">{{showketcher===false?"打开画板":"隐藏画板" }}
      </n-button>
    </n-input-group>
...
.ketcher>iframe {
  position: absolute;
  transform:scale(0.8);left: -100px;top: -70px;
}
.inputG{
    width: 850px;
    position: relative;
